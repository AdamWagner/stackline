-- -----------------------------------------------------------------------------
-- FROM: https://github.com/luapower/heap/blob/master/heap.lua
-- -----------------------------------------------------------------------------
...
local function cdataheap(h)
    ...
    local cmp = h.cmp and function(i, j)
        return h.cmp(t[i], t[j])
    end or function(i, j)
        return t[i] < t[j]
    end
...
return {heap = heap, valueheap = valueheap, cdataheap = cdataheap}
