...
--[[
Checks if `Module` is a (or inherits from)...@return boolean
]]
...
@param  table(...) - `Mixins`@return new `Module`
]]
...
@param  ... - arguments@return new `Module` instance
]]
...
function Modern:meta()  -- {{{
  local tableData = {{ '[ ]', 'DataType', 'Key', 'Value' }}
  local tableWidth = 0
  local colData = {}
  local overrides = {}
  local padding = 2
